...
:PROPERTIES:
:EXPORT_HUGO_PUBLISHDATE: [2025-11-22 Sat 13:51]
:EXPORT_FILE_NAME: phong-cach-song
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :featured_image "/assets/img/tom-te-bach-thach.png"
:END:
# :EXPORT_HUGO_EXPIRYDATE: 
...
#+NAME: fig:ca-te-bach-thach
#+CAPTION: Hồ cá, phong cách màu nước của Tề Bạch Thạch
#+ATTR_LaTeX: :height 8cm :placement [!htpb]
[[file:/assets/img/ca-te-bach-thach.png]]
...
:EXPORT_FILE_NAME: chan-troi-su-kien 
